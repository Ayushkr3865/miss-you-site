...
export default function FinalScreen({ ...motionProps }) {
    ...
    const finalMessage =
        "Even miles apart, you're all I think about. Every second without you feels incomplete. I miss your smile(special tha haa), your laugh, your voice — everything. You are my peace in this noisy world. No matter the distance, you'll always live in my heart. I can't wait for the day I met you again. Until then,enjoy and just know... I miss you more than words can ever say..just enjoy your vacation and come fast or pahadon mai gir ke injury mat kar lenai..🌙💕"
    ...
    return (
        <motion.div {...motionProps} className="min-h-screen flex items-center justify-center text-center px-6 relative">
            ...
            <div className="max-w-4xl z-10">
                ...
                >
                    Forever Yours good listener and please naraz hona mujhse but kabhi serious waala gussa nahi..
                </motion.h2>
